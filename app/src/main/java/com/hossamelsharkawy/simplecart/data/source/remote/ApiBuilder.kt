...
object ApiBuilder {
    ...
    fun setBaseUrl(mBaseUrl: String) = apply {
        ApiBuilder.mBaseUrl = mBaseUrl
    }

    fun setCache(cache: Cache) = apply {
        ApiBuilder.cache = cache
    }
    ...
    fun setAuth(
        ...
        ApiBuilder.authenticator = authenticator
        ApiBuilder.authenticationInterceptor = authenticationInterceptor
    }
